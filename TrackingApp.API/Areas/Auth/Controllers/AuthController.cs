...
namespace TrackingApp.API.Areas.Auth.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> RegisterAdmin([FromBody] RegisterModel model)
        {
            ...
            if (!await _roleManager.RoleExistsAsync(Constants.Admin))
                await _roleManager.CreateAsync(new ApplicationRole() { Name = Constants.Admin });
            if (!await _roleManager.RoleExistsAsync(Constants.User))
                await _roleManager.CreateAsync(new ApplicationRole() { Name = Constants.User });
